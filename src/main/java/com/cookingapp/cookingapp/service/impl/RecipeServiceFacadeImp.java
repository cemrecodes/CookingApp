...
public class RecipeServiceFacadeImp implements RecipeServiceFacade {
  ...
  private final IngredientDraftService ingredientDraftService;
  ...
  @Override
  public RecipeDraft saveRecipeToDraft(RecipeDraft recipe, List<IngredientDraft> ingredientList, Member member) {
    RecipeDraft recipeDraft = recipeDraftService.save(recipe);
    for (IngredientDraft ingredient : ingredientList) {
      ingredient.setRecipe(recipeDraft);
    }
    ingredientDraftService.saveAll(ingredientList);
    recipe.setIngredients(ingredientList);
    return recipe;
  }
